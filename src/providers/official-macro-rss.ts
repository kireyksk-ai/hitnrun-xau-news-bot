...
const feeds: Feed[] = [
  ...
  { name: "fed-speeches-rss", url: "https://www.federalreserve.gov/feeds/speeches_and_testimony.xml", sourceName: "Federal Reserve (Speeches & Testimony)", matches: /rate|inflation|economy|labor market|financial stability|monetary policy|outlook|economic conditions|fomc|banking system/i },
