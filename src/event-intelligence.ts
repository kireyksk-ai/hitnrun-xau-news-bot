...
const macro = /\b(cpi|pce|ppi|nfp|payroll|unemployment|wage growth|jolts|retail sales|gdp|ism|pmi|jobless claims|consumer confidence|housing starts|inflation data|consumer sentiment|inflation expectations|michigan (?:consumer )?sentiment|durable goods|factory orders|industrial production|new home sales|existing home sales|pending home sales|building permits|trade (?:balance|deficit)|personal (?:income|spending)|consumer spending|gdpnow|productivity|unit labor costs|import prices|export prices|empire state|philly fed|richmond fed|chicago pmi)\b/i;
