...
const macro = /\b(cpi|pce|ppi|nfp|payroll|unemployment|wage growth|jolts|retail sales|gdp|ism|pmi|jobless claims|consumer confidence|housing starts|inflation data)\b/i;
